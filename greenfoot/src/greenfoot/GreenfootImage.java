...
public class GreenfootImage
{
    ...
    {
        this(string, new Font(Font.SANS_SERIF, Font.PLAIN, size), foreground.getColorObject(), background.getColorObject(), outline.getColorObject());
    }
    ...
    {
        this(string, font.getFontObject(), foreground.getColorObject(), background.getColorObject(), outline.getColorObject());
    }
